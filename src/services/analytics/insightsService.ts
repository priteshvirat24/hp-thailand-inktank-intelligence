...
export class InsightsService {
  private readonly authoritativeInsights: readonly ExecutiveInsight[] = [
    ...
    // ========================================================================
    {
      ...
      channel_focus: 'Google Ads, Meta Ads, Shopee, Pantip',
      is_ceo_top_pick: true,
      evidence_ids: [
        'EVID-GOOGLE-69FDD6148B57',
        'EVID-META-A21AF529CC49',
        'EVID-SHOPEE-15217065A381',
        'EVID-REVIEW-CANON-TCO-01',
      ],
      sources: [
        { platform: 'Google', label: 'Google Search Ads Transparency (Canon Thailand)', url: 'https://adstransparency.google.com/?region=TH&q=Canon+PIXMA' },
    ...
    // ========================================================================
    {
      ...
      channel_focus: 'Google Ads B2B, JIB B2B, Official HP Store',
      is_ceo_top_pick: false,
      evidence_ids: [
        'EVID-JIB-C61F5D27825E',
        'EVID-GOOGLE-2529ECA85C83',
      ...
      sources: [
        ...
        { platform: 'Google', label: 'Google Search Ads B2B Print Segment', url: 'https://adstransparency.google.com/?region=TH&q=HP+Smart+Tank+720' },
